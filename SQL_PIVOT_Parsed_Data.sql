...
FROM  
    (SELECT (SELECT Agency.AgencyName FROM Agency WHERE Agency.AgencyID = Survey.AgencyID) AS 'Agency', (SELECT Year FROM Years WHERE Years.YearID= Survey.YearID) AS 'Year', QuestionNumber, ResponseValue FROM Survey)   
    AS Survey
PIVOT  
(  
    MAX(ResponseValue)  
